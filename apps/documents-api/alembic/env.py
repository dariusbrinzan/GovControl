...
import documents_app.models  # noqa: F401
...
config.set_main_option("sqlalchemy.url", get_settings().documents_database_url)
...
def include_name(name: str | None, type_: str, parent_names: dict[str, str | None]) -> bool:
    ...
    return parent_names.get("schema_name") in {None, "documents"}
